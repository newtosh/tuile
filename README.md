...
**Downstream Go projects:** `go get github.com/newtosh/tuile@v0.2.2` and import `github.com/newtosh/tuile/testkit` — full guide in [docs/adoption.md](docs/adoption.md).
