...
```bash
curl -sL https://github.com/newtosh/tuile/releases/download/v0.2.2/tuile-linux-amd64 -o tuile
chmod +x tuile
```
...
```bash
go get github.com/newtosh/tuile@v0.2.2
```
...
- **Tag semver releases** (`v0.1.0`, `v0.1.1`, `v0.1.2`, `v0.2.0`, `v0.2.1`, `v0.2.2`, …) so pkg.go.dev and `go install` stay current.
